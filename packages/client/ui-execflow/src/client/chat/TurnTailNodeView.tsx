...
import type { ChatNodeViewProps, TurnTailOwnerProps } from '../contract/execflow-slots.ts'
import { MessageIconActions } from './MessageIconActions.tsx'
import { assistantText } from './turn-assistant.ts'
import css from './TurnTailNodeView.module.css'

type TurnTailNodeViewProps = ChatNodeViewProps<'turn-tail'>
  & PropsRenderSlots<'execflow.chat.turnTail' | 'execflow.chat.assistant-actions'>
...
export const TurnTailNodeView = memo(function TurnTailNodeView({
  ...
  const tail = renderSlotChain('execflow.chat.turnTail', owner)
  ...
  const assistantActions = messageId === undefined
    ? null
    : renderSlot('execflow.chat.assistant-actions', { messageId })
  return (
