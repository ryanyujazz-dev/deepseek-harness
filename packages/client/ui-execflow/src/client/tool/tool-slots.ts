...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
     ...
     */
    'execflow.tool.call.toolview': { kind: 'keyed'; scope: 'session'; owner: ToolCallOwnerProps }
  }
}
...
export type ToolCallViewProps = PropsRuntime<'execflow.tool.call.toolview'>

/** Full props of the Tool call-tree renderer registered as a `tool-call` Chat Node. */
export type ToolTreeProps = PropsRuntime<'execflow.chat.node', 'tool-call'>
  & PropsRenderSlots<'execflow.tool.call.toolview'>
