...
export const webToolview = {
  ...
  apply(ctx: Context): void {
    ctx.slots.inject('execflow.tool.call.toolview', function* () {
      yield ctx.slots.register({ name: 'execflow.tool.call.toolview', key: 'web_search', locale: NS }, WebRow)
      yield ctx.slots.register({ name: 'execflow.tool.call.toolview', key: 'web_fetch', locale: NS }, WebRow)
    })
  },
}
