...
export const searchToolview = {
  ...
  apply(ctx: Context): void {
    ctx.slots.inject('execflow.tool.call.toolview', function* () {
      yield ctx.slots.register({ name: 'execflow.tool.call.toolview', key: 'grep', locale: NS }, SearchRow)
      yield ctx.slots.register({ name: 'execflow.tool.call.toolview', key: 'glob', locale: NS }, SearchRow)
    })
  },
}
