...
// 'execflow.tool.call.toolview' hole like todo-row. The row composes ToolRow
...
export const askQuestionToolview = {
  ...
  apply(ctx: Context): void {
    ctx.slots.inject('execflow.tool.call.toolview', () => ctx.slots.register({
      name: 'execflow.tool.call.toolview', key: 'ask_user_question', locale: NS,
    }, AskQuestionRow))
  },
}
