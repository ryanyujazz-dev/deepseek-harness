...
export const fileMutationToolview = {
  ...
  apply(ctx: Context): void {
    ctx.slots.inject('execflow.tool.call.toolview', function* () {
      yield ctx.slots.register({ name: 'execflow.tool.call.toolview', key: 'edit', locale: NS }, FileMutationRow)
      yield ctx.slots.register({ name: 'execflow.tool.call.toolview', key: 'write', locale: NS }, FileMutationRow)
    })
  },
}
