...
// "Tool call" card, registered into the keyed 'execflow.tool.call.toolview'
...
export const todoToolview = {
  ...
  apply(ctx: Context): void {
    ctx.slots.inject('execflow.tool.call.toolview', () =>
      ctx.slots.register({ name: 'execflow.tool.call.toolview', key: 'todo_write', locale: NS }, TodoRow))
  },
}
