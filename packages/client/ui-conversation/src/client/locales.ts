...
export const zh = {
  ...
  'execflow.think.more': '显示更多',
  'execflow.think.less': '收起',
  'execflow.menu.display': '显示方式',
  'execflow.menu.normal': '标准',
  'execflow.menu.think': '思考',
  'execflow.menu.aria': '执行流显示方式',
  'execflow.status.showThink': '显示思考内容',
  'execflow.status.hideThink': '隐藏思考内容',
  'execflow.status.thinking': 'Thinking',
  'execflow.inspect': 'Inspect',
  'execflow.draft.editing': 'Editing',
  'execflow.draft.creating': 'Creating',
  'execflow.draft.planning': 'Planning',
  'execflow.draft.coding': 'Coding',
  'execflow.draft.todos': 'Updating todos',
  'execflow.agg.edit': '编辑 {count} 个文件',
  'execflow.agg.edit.one': '编辑 1 个文件',
  'execflow.agg.create': '创建 {count} 个文件',
  'execflow.agg.create.one': '创建 1 个文件',
  'execflow.agg.read': '读取 {count} 个文件',
  'execflow.agg.read.one': '读取 1 个文件',
  'execflow.agg.fetch': '抓取 {count} 个页面',
  'execflow.agg.fetch.one': '抓取 1 个页面',
  'execflow.agg.searchTime': '搜索 {count} 次',
  'execflow.agg.searchTime.one': '搜索 1 次',
  'execflow.agg.searchPattern': '搜索 {count} 个模式',
  'execflow.agg.searchPattern.one': '搜索 1 个模式',
  'execflow.agg.list': '列出 {count} 个路径',
  'execflow.agg.list.one': '列出 1 个路径',
  'execflow.agg.run': '运行 {count} 条命令',
  'execflow.agg.run.one': '运行 1 条命令',
...
export const en = {
  ...
  'execflow.menu.normal': 'Normal',
  'execflow.menu.think': 'Think',
  'execflow.menu.aria': 'ExecFlow display mode',
  'execflow.status.showThink': 'Show Thinking content',
  'execflow.status.hideThink': 'Hide Thinking content',
  'execflow.status.thinking': 'Thinking',
  'execflow.inspect': 'Inspect',
  'execflow.draft.editing': 'Editing',
  'execflow.draft.creating': 'Creating',
  ...
  'execflow.draft.coding': 'Coding',
  'execflow.draft.todos': 'Updating todos',
  'execflow.agg.edit': 'Edit {count} files',
  'execflow.agg.edit.one': 'Edit 1 file',
  'execflow.agg.create': 'Create {count} files',
  'execflow.agg.create.one': 'Create 1 file',
  'execflow.agg.read': 'Read {count} files',
  'execflow.agg.read.one': 'Read 1 file',
  'execflow.agg.fetch': 'Fetch {count} pages',
  'execflow.agg.fetch.one': 'Fetch 1 page',
  'execflow.agg.searchTime': 'Search {count} times',
  'execflow.agg.searchTime.one': 'Search 1 time',
  'execflow.agg.searchPattern': 'Search {count} patterns',
  'execflow.agg.searchPattern.one': 'Search 1 pattern',
  'execflow.agg.list': 'List {count} paths',
  'execflow.agg.list.one': 'List 1 path',
  'execflow.agg.run': 'Run {count} commands',
  'execflow.agg.run.one': 'Run 1 command',
